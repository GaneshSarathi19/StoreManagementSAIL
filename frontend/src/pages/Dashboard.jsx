      ...
      <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '1.5rem' }}>
        ...
        <div className="glass-card" style={{ padding: '1.5rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', marginTop: '1.5rem' }}>
            ...
            <Link to="/inventory" className="btn" style={{ background: 'rgba(255,255,255,0.05)', color: '#fff', textDecoration: 'none', justifyContent: 'center', border: '1px solid rgba(255,255,255,0.1)' }}>
